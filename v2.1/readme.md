...
[[switch%20attachment%20points.png]]
...
![front](/power-switch%20(ds%20lite)/front.png)  ![back](/power-switch%20(ds%20lite)/back.png)

or the rotary board (recommended for "one chip" backlights)

![front]("\power-switch%20(rotary)\front.png")  ![back]("/power-switch%20(rotary)/back.png")
