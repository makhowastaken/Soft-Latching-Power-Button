...
<img src="switch_attachment_points.png" width="25%" height="25%">
...
<img src="power-switch(ds_lite)/front.png" width="25%" height="25%">  <img src="power-switch(ds_lite)/back.png" width="25%" height="25%">

or the rotary board (recommended for "one chip" backlights)

<img src="power-switch(rotary)\front.png" width="25%" height="25%">  <img src="power-switch(rotary)/back.png" width="25%" height="25%">
